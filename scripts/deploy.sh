...
build() {
  docker build -f ./docker/Dockerfile -t "192.168.68.108:5000/music-stream-api:${VERSION}" .
}

push() {
  docker push "192.168.68.108:5000/music-stream-api:${VERSION}"
}
